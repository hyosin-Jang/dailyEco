...
public class edit_goal_list extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoalData reusable_bag = new GoalData("reusable bag", R.drawable.reusablebag_on, 1);
        GoalData stairs = new GoalData("stairs", R.drawable.stairs_on, 1);
        GoalData tumbler = new GoalData("tumbler", R.drawable.tumbler_on, 1);
